	...
	extern bool Test_GpuBruteforce ()
	{
		...
		CHECK_ERR( factory->Create(
						...
						CreateInfo::GpuBuffer{
							BufferDescription{ SizeOf<Pipelines::Bruteforce_InputsSSBO>, EBufferUsage::Storage },
		...
		CHECK_ERR( factory->Create(
						...
						gpu_thread->GlobalSystems(),
						CreateInfo::GpuBuffer{
							BufferDescription{ SizeOf<Pipelines::Bruteforce_OutputsSSBO>, EBufferUsage::Storage },
							EGpuMemory::CoherentWithCPU },
						OUT ssb_output ) );
