...
=================================================
*/
	bool CodeGenApp::_OnWindowClosed (const OSMsg::WindowAfterDestroy &)
	{
		_looping = false;
		return true;
	}
...
=================================================
*/
	bool CodeGenApp::_Draw (const ModuleMsg::Update &)
	{
		if ( not _looping )
			return false;
...
=================================================
*/
	bool CodeGenApp::_GInit (const GpuMsg::DeviceCreated &)
	{
...
=================================================
*/
	bool CodeGenApp::_GDelete (const GpuMsg::DeviceBeforeDestroy &)
	{
		_gpuThread	= null;
		return true;
	}
...
int main (int argc, char** argv)
{
	...
	OS::FileSystem::FindAndSetCurrentDir( "Projects/ProgramSynthesis/Samples" );
